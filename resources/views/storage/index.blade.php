          ...
          <tr>
            <td>
              <div class="d-flex px-2 py-1">
                <div>
                  <img src="{{ asset('img/raspi.png') }}" class="me-3" alt="raspberry pi" style="width: 100px;">
                </div>
            ...
            <td class="align-middle text-center text-sm">
              <span class="text-xs font-weight-bold">{{ formatSizeFromKB($data->used_space) }}</span>                      
            </td>
            <td class="align-middle text-center text-sm">
              <span class="text-xs font-weight-bold">{{ formatSizeFromKB($data->total_space) }}</span>                      
            </td>
